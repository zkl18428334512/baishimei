...
Z([[4],[[5],[[5],[1,'cuIcon-pick']],[[2,'?:'],[[2,'==='],[[6],[[7],[3,'item']],[3,'status']],[1,0]],[1,'text-orange'],[1,'text-gray']]]])
...
Z([[4],[[5],[[5],[1,'cuIcon-pick']],[[2,'?:'],[[2,'==='],[[6],[[6],[[7],[3,'item']],[3,'$orig']],[3,'status']],[1,0]],[1,'text-orange'],[1,'text-gray']]]])
...
Z([[7],[3,'hasLogin']])
Z([a,[[2,'+'],[1,'您好! '],[[6],[[7],[3,'userInfo']],[3,'name']]]])
...
_(oP,xQ)
_(bO,oP)
var oR=_mz(z,'input',['bindinput',4,'data-event-opts',1,'name',2,'placeholder',3,'value',4],[],e,s,gg)
_(bO,oR)
var fS=_n('view')
...
_(aZ,t1)
_(oX,aZ)
var e2=_mz(z,'input',['bindinput',17,'data-event-opts',1,'name',2,'placeholder',3,'value',4],[],e,s,gg)
_(oX,e2)
var lY=_v()
_(oX,lY)
if(_oz(z,22,e,s,gg)){lY.wxVkey=1
var b3=_mz(z,'button',['bindtap',23,'class',1,'data-event-opts',2],[],e,s,gg)
...
var c8=_mz(z,'button',['bindtap',30,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var oHB=_v()
_(eFB,oHB)
if(_oz(z,4,tEB,aDB,gg)){oHB.wxVkey=1
var xIB=_n('view')
_rz(z,xIB,'class',5,tEB,aDB,gg)
var oJB=_n('view')
_rz(z,oJB,'class',6,tEB,aDB,gg)
var fKB=_oz(z,7,tEB,aDB,gg)
_(oJB,fKB)
_(xIB,oJB)
var cLB=_v()
_(xIB,cLB)
...
var aRB=_n('view')
_rz(z,aRB,'class',12,cOB,oNB,gg)
var tSB=_n('view')
_rz(z,tSB,'class',13,cOB,oNB,gg)
var eTB=_n('view')
_rz(z,eTB,'class',14,cOB,oNB,gg)
var bUB=_n('view')
_rz(z,bUB,'class',15,cOB,oNB,gg)
var oVB=_n('view')
_rz(z,oVB,'class',16,cOB,oNB,gg)
var xWB=_oz(z,17,cOB,oNB,gg)
_(oVB,xWB)
_(bUB,oVB)
var oXB=_n('view')
_rz(z,oXB,'class',18,cOB,oNB,gg)
var fYB=_oz(z,19,cOB,oNB,gg)
_(oXB,fYB)
_(bUB,oXB)
_(eTB,bUB)
var cZB=_n('view')
_rz(z,cZB,'class',20,cOB,oNB,gg)
var h1B=_n('view')
_rz(z,h1B,'class',21,cOB,oNB,gg)
var o2B=_oz(z,22,cOB,oNB,gg)
_(h1B,o2B)
_(cZB,h1B)
_(eTB,cZB)
_(tSB,eTB)
var c3B=_mz(z,'view',['bindtap',23,'class',1,'data-event-opts',2],[],cOB,oNB,gg)
var l5B=_n('view')
_rz(z,l5B,'class',26,cOB,oNB,gg)
var a6B=_n('view')
_rz(z,a6B,'class',27,cOB,oNB,gg)
_(l5B,a6B)
var t7B=_n('view')
var e8B=_oz(z,28,cOB,oNB,gg)
_(t7B,e8B)
_(l5B,t7B)
_(c3B,l5B)
var b9B=_n('view')
_rz(z,b9B,'class',29,cOB,oNB,gg)
var o0B=_n('view')
_rz(z,o0B,'class',30,cOB,oNB,gg)
_(b9B,o0B)
var xAC=_n('view')
var oBC=_oz(z,31,cOB,oNB,gg)
_(xAC,oBC)
_(b9B,xAC)
_(c3B,b9B)
var fCC=_n('view')
_rz(z,fCC,'class',32,cOB,oNB,gg)
var cDC=_n('view')
_rz(z,cDC,'class',33,cOB,oNB,gg)
_(fCC,cDC)
var hEC=_n('view')
var oFC=_oz(z,34,cOB,oNB,gg)
_(hEC,oFC)
_(fCC,hEC)
_(c3B,fCC)
var o4B=_v()
_(c3B,o4B)
if(_oz(z,35,cOB,oNB,gg)){o4B.wxVkey=1
var cGC=_n('view')
_rz(z,cGC,'class',36,cOB,oNB,gg)
var oHC=_n('view')
_rz(z,oHC,'class',37,cOB,oNB,gg)
_(cGC,oHC)
var lIC=_n('view')
var aJC=_oz(z,38,cOB,oNB,gg)
_(lIC,aJC)
_(cGC,lIC)
_(o4B,cGC)
}
...
cLB.wxXCkey=2
_2z(z,10,hMB,tEB,aDB,gg,cLB,'data','__i0__','deliveryOrderId')
_(oHB,xIB)
}
else{oHB.wxVkey=2
var tKC=_n('view')
_rz(z,tKC,'class',39,tEB,aDB,gg)
var eLC=_oz(z,40,tEB,aDB,gg)
_(tKC,eLC)
_(oHB,tKC)
}
oHB.wxXCkey=1
...
_(tCD,eDD)
var bED=_mz(z,'input',['bindinput',22,'confirmType',1,'data-event-opts',2,'placeholder',3,'type',4],[],e,s,gg)
_(tCD,bED)
_(aBD,tCD)
_(lAD,aBD)
var oFD=_v()
...
var oLD=_n('view')
_rz(z,oLD,'class',31,fID,oHD,gg)
var cMD=_mz(z,'view',['class',32,'style',1],[],fID,oHD,gg)
_(oLD,cMD)
var oND=_n('view')
_rz(z,oND,'class',34,fID,oHD,gg)
var lOD=_n('view')
_rz(z,lOD,'class',35,fID,oHD,gg)
var aPD=_oz(z,36,fID,oHD,gg)
_(lOD,aPD)
var tQD=_n('view')
_rz(z,tQD,'class',37,fID,oHD,gg)
var eRD=_n('view')
_rz(z,eRD,'class',38,fID,oHD,gg)
_(tQD,eRD)
var bSD=_n('view')
var oTD=_oz(z,39,fID,oHD,gg)
_(bSD,oTD)
_(tQD,bSD)
_(lOD,tQD)
_(oND,lOD)
var xUD=_n('view')
_rz(z,xUD,'class',40,fID,oHD,gg)
var oVD=_n('view')
_rz(z,oVD,'class',41,fID,oHD,gg)
var fWD=_oz(z,42,fID,oHD,gg)
_(oVD,fWD)
_(xUD,oVD)
var cXD=_n('view')
_rz(z,cXD,'class',43,fID,oHD,gg)
var hYD=_n('view')
_rz(z,hYD,'class',44,fID,oHD,gg)
var oZD=_oz(z,45,fID,oHD,gg)
_(hYD,oZD)
_(cXD,hYD)
var c1D=_n('view')
_rz(z,c1D,'class',46,fID,oHD,gg)
var o2D=_mz(z,'input',['bindinput',47,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],fID,oHD,gg)
_(c1D,o2D)
_(cXD,c1D)
_(xUD,cXD)
_(oND,xUD)
_(oLD,oND)
var l3D=_mz(z,'view',['bindtap',52,'class',1,'data-event-opts',2],[],fID,oHD,gg)
var a4D=_n('view')
_rz(z,a4D,'class',55,fID,oHD,gg)
_(l3D,a4D)
_(oLD,l3D)
_(cJD,oLD)
return cJD
...
oFD.wxXCkey=2
_2z(z,29,xGD,e,s,gg,oFD,'item','__i0__','deliveryOrderItemId')
_(cRC,lAD)
}
cRC.wxXCkey=1
_(oPC,fQC)
...
var b7D=_mz(z,'image',['class',1,'src',1],[],e,s,gg)
_(e6D,b7D)
var o8D=_n('view')
var x9D=_n('text')
...
var bKE=_n('view')
_rz(z,bKE,'class',6,oFE,cEE,gg)
var oLE=_oz(z,7,oFE,cEE,gg)
_(bKE,oLE)
_(eJE,bKE)
var xME=_v()
_(eJE,xME)
...
var cSE=_n('view')
_rz(z,cSE,'class',12,cPE,fOE,gg)
var oTE=_n('view')
_rz(z,oTE,'class',13,cPE,fOE,gg)
var lUE=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2],[],cPE,fOE,gg)
var aVE=_n('view')
_rz(z,aVE,'class',17,cPE,fOE,gg)
var tWE=_n('view')
_rz(z,tWE,'class',18,cPE,fOE,gg)
var eXE=_n('view')
_rz(z,eXE,'class',19,cPE,fOE,gg)
_(tWE,eXE)
var bYE=_n('view')
var oZE=_oz(z,20,cPE,fOE,gg)
_(bYE,oZE)
_(tWE,bYE)
_(aVE,tWE)
_(lUE,aVE)
var x1E=_n('view')
_rz(z,x1E,'class',21,cPE,fOE,gg)
var o2E=_n('view')
_rz(z,o2E,'class',22,cPE,fOE,gg)
var f3E=_oz(z,23,cPE,fOE,gg)
_(o2E,f3E)
_(x1E,o2E)
_(lUE,x1E)
_(oTE,lUE)
...
xME.wxXCkey=2
_2z(z,10,oNE,oFE,cEE,gg,xME,'data','__i0__','deliverDate')
_(tIE,eJE)
}
else{tIE.wxVkey=2
var c4E=_n('view')
_rz(z,c4E,'class',24,oFE,cEE,gg)
var h5E=_oz(z,25,oFE,cEE,gg)
_(c4E,h5E)
_(tIE,c4E)
}
tIE.wxXCkey=1
...
_(hIF,oJF)
var cKF=_mz(z,'input',['bindinput',12,'confirmType',1,'data-event-opts',2,'placeholder',3,'type',4],[],e,s,gg)
_(hIF,cKF)
_(cHF,hIF)
_(fGF,cHF)
_(tAF,fGF)
...
var xSF=_n('view')
_rz(z,xSF,'class',22,ePF,tOF,gg)
var oTF=_n('view')
_rz(z,oTF,'class',23,ePF,tOF,gg)
var fUF=_n('view')
_rz(z,fUF,'class',24,ePF,tOF,gg)
var cVF=_mz(z,'view',['class',25,'style',1],[],ePF,tOF,gg)
_(fUF,cVF)
var hWF=_n('view')
_rz(z,hWF,'class',27,ePF,tOF,gg)
var oXF=_oz(z,28,ePF,tOF,gg)
_(hWF,oXF)
_(fUF,hWF)
_(oTF,fUF)
_(xSF,oTF)
var cYF=_n('view')
_rz(z,cYF,'class',29,ePF,tOF,gg)
var oZF=_v()
_(cYF,oZF)
var l1F=function(t3F,a2F,e4F,gg){
var o6F=_n('view')
_rz(z,o6F,'class',34,t3F,a2F,gg)
var x7F=_n('view')
_rz(z,x7F,'class',35,t3F,a2F,gg)
var f9F=_n('view')
_rz(z,f9F,'class',36,t3F,a2F,gg)
var c0F=_n('view')
_rz(z,c0F,'class',37,t3F,a2F,gg)
var hAG=_n('view')
_rz(z,hAG,'class',38,t3F,a2F,gg)
_(c0F,hAG)
var oBG=_n('view')
var cCG=_oz(z,39,t3F,a2F,gg)
_(oBG,cCG)
_(c0F,oBG)
_(f9F,c0F)
var oDG=_n('view')
_rz(z,oDG,'class',40,t3F,a2F,gg)
var lEG=_n('view')
_rz(z,lEG,'class',41,t3F,a2F,gg)
_(oDG,lEG)
var aFG=_n('view')
var tGG=_oz(z,42,t3F,a2F,gg)
_(aFG,tGG)
_(oDG,aFG)
_(f9F,oDG)
_(x7F,f9F)
var o8F=_v()
_(x7F,o8F)
if(_oz(z,43,t3F,a2F,gg)){o8F.wxVkey=1
var eHG=_n('view')
_rz(z,eHG,'class',44,t3F,a2F,gg)
var bIG=_n('view')
_rz(z,bIG,'class',45,t3F,a2F,gg)
var oJG=_n('view')
_rz(z,oJG,'class',46,t3F,a2F,gg)
_(bIG,oJG)
var xKG=_n('view')
var oLG=_oz(z,47,t3F,a2F,gg)
_(xKG,oLG)
_(bIG,xKG)
_(eHG,bIG)
_(o8F,eHG)
...
var fMG=_n('view')
_rz(z,fMG,'class',48,t3F,a2F,gg)
var cNG=_n('view')
_rz(z,cNG,'class',49,t3F,a2F,gg)
var hOG=_oz(z,50,t3F,a2F,gg)
_(cNG,hOG)
_(fMG,cNG)
var oPG=_n('view')
_rz(z,oPG,'class',51,t3F,a2F,gg)
var cQG=_n('view')
_rz(z,cQG,'class',52,t3F,a2F,gg)
var oRG=_oz(z,53,t3F,a2F,gg)
_(cQG,oRG)
_(oPG,cQG)
var lSG=_n('view')
_rz(z,lSG,'class',54,t3F,a2F,gg)
var aTG=_mz(z,'input',['bindinput',55,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],t3F,a2F,gg)
_(lSG,aTG)
_(oPG,lSG)
_(fMG,oPG)
_(x7F,fMG)
o8F.wxXCkey=1
_(o6F,x7F)
var tUG=_mz(z,'view',['bindtap',60,'class',1,'data-event-opts',2],[],t3F,a2F,gg)
var eVG=_n('view')
_rz(z,eVG,'class',63,t3F,a2F,gg)
_(tUG,eVG)
_(o6F,tUG)
_(e4F,o6F)
return e4F
...
oZF.wxXCkey=2
_2z(z,32,l1F,ePF,tOF,gg,oZF,'item','__i1__','purchaseOrderItemId')
_(xSF,cYF)
_(bQF,xSF)
return bQF
}
lMF.wxXCkey=2
_2z(z,20,aNF,e,s,gg,lMF,'data','__i0__','productId')
_(c7E,oLF)
o8E.wxXCkey=1
_(r,c7E)
return r
...
_(c2G,h3G)
_(f1G,c2G)
var o4G=_mz(z,'input',['bindinput',4,'data-event-opts',1,'name',2,'placeholder',3,'value',4],[],e,s,gg)
_(f1G,o4G)
var c5G=_n('view')
...
_(oBH,xCH)
_(e0G,oBH)
var oDH=_mz(z,'input',['bindinput',17,'data-event-opts',1,'name',2,'placeholder',3,'value',4],[],e,s,gg)
_(e0G,oDH)
var bAH=_v()
_(e0G,bAH)
if(_oz(z,22,e,s,gg)){bAH.wxVkey=1
var fEH=_mz(z,'button',['bindtap',23,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oJH=_mz(z,'button',['bindtap',30,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var aLH=_mz(z,'view',['class',36,'style',1],[],e,s,gg)
var tMH=_v()
_(aLH,tMH)
var eNH=function(oPH,bOH,xQH,gg){
var fSH=_n('view')
_rz(z,fSH,'class',42,oPH,bOH,gg)
var cTH=_mz(z,'image',['bindtap',43,'data-event-opts',1,'src',2],[],oPH,bOH,gg)
_(fSH,cTH)
_(xQH,fSH)
return xQH
}
tMH.wxXCkey=2
_2z(z,40,eNH,e,s,gg,tMH,'provider','__i0__','value')
_(xYG,aLH)
}
xYG.wxXCkey=1
_(r,oXG)
...
var lCI=_v()
_(cAI,lCI)
if(_oz(z,13,o0H,h9H,gg)){lCI.wxVkey=1
var aDI=_n('view')
_rz(z,aDI,'class',14,o0H,h9H,gg)
var tEI=_mz(z,'view',['bindtap',15,'class',1,'data-event-opts',2],[],o0H,h9H,gg)
var eFI=_v()
_(tEI,eFI)
if(_oz(z,18,o0H,h9H,gg)){eFI.wxVkey=1
var bGI=_n('view')
_rz(z,bGI,'class',19,o0H,h9H,gg)
var oHI=_v()
_(bGI,oHI)
if(_oz(z,20,o0H,h9H,gg)){oHI.wxVkey=1
var xII=_oz(z,21,o0H,h9H,gg)
_(oHI,xII)
}
oHI.wxXCkey=1
_(eFI,bGI)
...
var hMI=_mz(z,'image',['mode',25,'src',1],[],e,s,gg)
_(cLI,hMI)
var oNI=_n('view')
...
var oXI=_v()
_(oVI,oXI)
if(_oz(z,4,bUI,eTI,gg)){oXI.wxVkey=1
var fYI=_n('view')
_rz(z,fYI,'class',5,bUI,eTI,gg)
var cZI=_n('view')
_rz(z,cZI,'class',6,bUI,eTI,gg)
var h1I=_oz(z,7,bUI,eTI,gg)
_(cZI,h1I)
_(fYI,cZI)
var o2I=_v()
_(fYI,o2I)
...
var e8I=_n('view')
_rz(z,e8I,'class',12,l5I,o4I,gg)
var b9I=_n('view')
_rz(z,b9I,'class',13,l5I,o4I,gg)
var o0I=_n('view')
_rz(z,o0I,'class',14,l5I,o4I,gg)
var xAJ=_n('view')
_rz(z,xAJ,'class',15,l5I,o4I,gg)
var oBJ=_n('view')
_rz(z,oBJ,'class',16,l5I,o4I,gg)
var fCJ=_oz(z,17,l5I,o4I,gg)
_(oBJ,fCJ)
_(xAJ,oBJ)
var cDJ=_n('view')
_rz(z,cDJ,'class',18,l5I,o4I,gg)
var hEJ=_oz(z,19,l5I,o4I,gg)
_(cDJ,hEJ)
_(xAJ,cDJ)
_(o0I,xAJ)
var oFJ=_n('view')
_rz(z,oFJ,'class',20,l5I,o4I,gg)
var cGJ=_n('view')
_rz(z,cGJ,'class',21,l5I,o4I,gg)
var oHJ=_oz(z,22,l5I,o4I,gg)
_(cGJ,oHJ)
_(oFJ,cGJ)
_(o0I,oFJ)
_(b9I,o0I)
var lIJ=_mz(z,'view',['bindtap',23,'class',1,'data-event-opts',2],[],l5I,o4I,gg)
var eLJ=_n('view')
_rz(z,eLJ,'class',26,l5I,o4I,gg)
var bMJ=_n('view')
_rz(z,bMJ,'class',27,l5I,o4I,gg)
_(eLJ,bMJ)
var oNJ=_n('view')
var xOJ=_oz(z,28,l5I,o4I,gg)
_(oNJ,xOJ)
_(eLJ,oNJ)
_(lIJ,eLJ)
var oPJ=_n('view')
_rz(z,oPJ,'class',29,l5I,o4I,gg)
var fQJ=_n('view')
_rz(z,fQJ,'class',30,l5I,o4I,gg)
_(oPJ,fQJ)
var cRJ=_n('view')
var hSJ=_oz(z,31,l5I,o4I,gg)
_(cRJ,hSJ)
_(oPJ,cRJ)
_(lIJ,oPJ)
var aJJ=_v()
_(lIJ,aJJ)
if(_oz(z,32,l5I,o4I,gg)){aJJ.wxVkey=1
var oTJ=_n('view')
_rz(z,oTJ,'class',33,l5I,o4I,gg)
var cUJ=_n('view')
_rz(z,cUJ,'class',34,l5I,o4I,gg)
_(oTJ,cUJ)
var oVJ=_n('view')
var lWJ=_oz(z,35,l5I,o4I,gg)
_(oVJ,lWJ)
_(oTJ,oVJ)
_(aJJ,oTJ)
}
var tKJ=_v()
_(lIJ,tKJ)
if(_oz(z,36,l5I,o4I,gg)){tKJ.wxVkey=1
var aXJ=_n('view')
_rz(z,aXJ,'class',37,l5I,o4I,gg)
var tYJ=_n('view')
_rz(z,tYJ,'class',38,l5I,o4I,gg)
_(aXJ,tYJ)
var eZJ=_n('view')
var b1J=_oz(z,39,l5I,o4I,gg)
_(eZJ,b1J)
_(aXJ,eZJ)
_(tKJ,aXJ)
}
...
o2I.wxXCkey=2
_2z(z,10,c3I,bUI,eTI,gg,o2I,'data','__i0__','purchaseOrderId')
_(oXI,fYI)
}
else{oXI.wxVkey=2
var o2J=_n('view')
_rz(z,o2J,'class',40,bUI,eTI,gg)
var x3J=_oz(z,41,bUI,eTI,gg)
_(o2J,x3J)
_(oXI,o2J)
}
oXI.wxXCkey=1
...
aRI.wxXCkey=2
_2z(z,2,tSI,e,s,gg,aRI,'item','index','index')
_(r,lQI)
return r
}
...
var c9J=_v()
_(o8J,c9J)
if(_oz(z,18,e,s,gg)){c9J.wxVkey=1
var bSK=_n('view')
...
_(xUK,oVK)
var fWK=_mz(z,'input',['bindinput',23,'confirmType',1,'data-event-opts',2,'placeholder',3,'type',4],[],e,s,gg)
_(xUK,fWK)
_(oTK,xUK)
_(bSK,oTK)
var cXK=_v()
...
var a4K=_n('view')
_rz(z,a4K,'class',32,c1K,oZK,gg)
var t5K=_mz(z,'view',['class',33,'style',1],[],c1K,oZK,gg)
_(a4K,t5K)
var e6K=_n('view')
_rz(z,e6K,'class',35,c1K,oZK,gg)
var b7K=_n('view')
_rz(z,b7K,'class',36,c1K,oZK,gg)
var o8K=_oz(z,37,c1K,oZK,gg)
_(b7K,o8K)
var x9K=_n('view')
_rz(z,x9K,'class',38,c1K,oZK,gg)
var o0K=_n('view')
_rz(z,o0K,'class',39,c1K,oZK,gg)
_(x9K,o0K)
var fAL=_n('view')
var cBL=_oz(z,40,c1K,oZK,gg)
_(fAL,cBL)
_(x9K,fAL)
_(b7K,x9K)
_(e6K,b7K)
var hCL=_n('view')
_rz(z,hCL,'class',41,c1K,oZK,gg)
var oDL=_n('view')
_rz(z,oDL,'class',42,c1K,oZK,gg)
var cEL=_n('view')
_rz(z,cEL,'class',43,c1K,oZK,gg)
var oFL=_oz(z,44,c1K,oZK,gg)
_(cEL,oFL)
_(oDL,cEL)
var lGL=_n('view')
_rz(z,lGL,'class',45,c1K,oZK,gg)
var aHL=_mz(z,'input',['bindinput',46,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],c1K,oZK,gg)
_(lGL,aHL)
_(oDL,lGL)
_(hCL,oDL)
var tIL=_n('view')
_rz(z,tIL,'class',51,c1K,oZK,gg)
var eJL=_n('view')
_rz(z,eJL,'class',52,c1K,oZK,gg)
var bKL=_oz(z,53,c1K,oZK,gg)
_(eJL,bKL)
_(tIL,eJL)
var oLL=_n('view')
_rz(z,oLL,'class',54,c1K,oZK,gg)
var xML=_mz(z,'input',['bindinput',55,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],c1K,oZK,gg)
_(oLL,xML)
_(tIL,oLL)
_(hCL,tIL)
_(e6K,hCL)
_(a4K,e6K)
var oNL=_mz(z,'view',['bindtap',60,'class',1,'data-event-opts',2],[],c1K,oZK,gg)
var fOL=_n('view')
_rz(z,fOL,'class',63,c1K,oZK,gg)
_(oNL,fOL)
_(a4K,oNL)
_(o2K,a4K)
return o2K
...
cXK.wxXCkey=2
_2z(z,30,hYK,e,s,gg,cXK,'item','__i0__','purchaseOrderItemId')
_(c9J,bSK)
}
c9J.wxXCkey=1
_(h7J,o8J)
...
var oTL=_mz(z,'button',['bindtap',3,'data-event-opts',1,'type',2],[],e,s,gg)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3992:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3992:1)",{path:"./app.wxss"});    
__wxAppCode__['app.wxml']=$gwx('./app.wxml');

__wxAppCode__['colorui/components/cu-custom.wxss']=undefined;    
__wxAppCode__['colorui/components/cu-custom.wxml']=$gwx('./colorui/components/cu-custom.wxml');

__wxAppCode__['pages/bind/bind.wxss']=setCssToHead([".",[1],"cu-form-group .",[1],"title { min-width: -webkit-calc(4em + 15px); min-width: calc(4em + 15px); }\n.",[1],"action-row { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; }\n.",[1],"action-row wx-navigator { color: #007aff; padding: 0 ",[0,20],"; }\n.",[1],"oauth-row { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; position: absolute; top: 0; left: 0; width: 100%; }\n.",[1],"oauth-image { width: ",[0,100],"; height: ",[0,100],"; border: ",[0,1]," solid #dddddd; -webkit-border-radius: ",[0,100],"; border-radius: ",[0,100],"; margin: 0 ",[0,40],"; background-color: #ffffff; }\n.",[1],"oauth-image wx-image { width: ",[0,60],"; height: ",[0,60],"; margin: ",[0,20],"; }\n",],undefined,{path:"./pages/bind/bind.wxss"});    
